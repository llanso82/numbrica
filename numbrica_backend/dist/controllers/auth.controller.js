...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Verificar email con token' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Email verificado' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Token inválido' }),
